...
- (void)viewDidLoad
{
    ...
    self.navigationController.toolbar.tintColor = [UIColor colorWithRed:((float)((0x00a388 & 0xFF0000) >> 16))/255.0 green:((float)((0x00a388 & 0xFF00) >> 8))/255.0 blue:((float)(0x00a388 & 0xFF))/255.0 alpha:1.0];
...
//                                                                           action:@selector(constrain:)];
        self.toolbarItems = @[cancelButtonitem, flexibleSpace, doneButtonItem];
    }
